    ...
    <div className="min-h-screen flex flex-col bg-zinc-950">
      ...
      <div className="px-3 sm:px-8 lg:px-16 py-6 sm:py-8 bg-zinc-950">
        ...
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            <div key={i} className="w-full flex gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl bg-zinc-900 border-2 border-zinc-800">
              <div className="flex-shrink-0 w-24 sm:w-32 md:w-40 aspect-video rounded-lg bg-zinc-800 animate-pulse" />
              <div className="flex-1 min-w-0 space-y-2">
                ...
                <div className="h-4 w-full bg-zinc-800 rounded animate-pulse hidden sm:block" />
                <div className="h-4 w-2/3 bg-zinc-800 rounded animate-pulse hidden sm:block" />
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="px-3 sm:px-8 lg:px-16 py-6 sm:py-8 bg-zinc-950">
        <div className="h-8 sm:h-9 w-48 bg-zinc-800 rounded animate-pulse mb-4 sm:mb-6" />
